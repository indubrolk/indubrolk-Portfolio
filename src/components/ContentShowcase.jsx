              ...
              <div className="grid grid-cols-[repeat(auto-fit,minmax(320px,1fr))] gap-3">
                {videos.map((video) => (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="group flex flex-col gap-3 rounded-2xl border border-white/10 bg-gradient-to-br from-white/8 via-white/5 to-white/2 p-4 text-left shadow-inner shadow-white/5 transition hover:-translate-y-1 hover:border-white/25 hover:from-white/12"
                  >
